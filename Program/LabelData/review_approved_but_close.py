...
'''
func desc: Identify semantic anomalies pr (ReviewApproved → ClosePR)
'''
def review_approved_but_close(repo: str, scene: str):
    ...
    # Identify semantic anomalies pr (ReviewApproved → ClosePR)
    ...
    for index, row in df_check.iterrows():
        ...
        # Obtain user information (username, email) for the last ReviewApproved
